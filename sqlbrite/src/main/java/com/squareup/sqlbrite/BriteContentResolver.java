...
public final class BriteContentResolver {
  ...
  public QueryObservable createQuery(@NonNull final Uri uri, @Nullable final String[] projection,
    ...
    FlowableOnSubscribe<Query> subscribe = new FlowableOnSubscribe<Query>() {
      @Override public void subscribe(@io.reactivex.annotations.NonNull final FlowableEmitter<Query> e) throws Exception {
    ...
    final Flowable<Query> queryObservable = Flowable.create(subscribe, BackpressureStrategy.LATEST) //
                                                    .observeOn(scheduler) //
